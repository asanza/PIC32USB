...
ROM struct{BYTE bLength;BYTE bDscType;WORD string[31];}sd001={
sizeof(sd001),USB_DESCRIPTOR_STRING,
{'E','l','e','k','t','r','o','t','e','c','h','n','i','s','c','h','e',' ',
        'A','p','p','a','r','a','t','e',' ','G','m','b','H'
}};

//Product string descriptor
ROM struct{BYTE bLength;BYTE bDscType;WORD string[32];}sd002={
sizeof(sd002),USB_DESCRIPTOR_STRING,
{'S','V','S','1','0','0',' ','P','o','w','e','r',' ','D','i','s',
't','r','i','b','u','t','i','o','n',' ','S','y','s','t','e','m'}};
